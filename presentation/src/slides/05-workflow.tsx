    ...
    <div className="relative w-full h-full">
      <Canvas>
        <Node x={200} y={180} kind="agent" tone="accent" active
              title="planner" subtitle="gemini-3.1-pro-preview" kicker="STEP 1" />
        <Node x={500} y={180} kind="agent" tone="accent"
              title="researcher" subtitle="gemini-3-flash-preview · google_search" kicker="STEP 2" />
        <Node x={800} y={180} kind="agent" tone="accent"
              title="writer" subtitle="gemini-3.1-pro-preview" kicker="STEP 3" />
