...
root_agent = LlmAgent(name="root", model="gemini-3-flash-preview",
                     tools=[billing])
```
...
root_agent = LlmAgent(name="notion_agent", model="gemini-3-flash-preview",
                     tools=[notion])
```
...
root = LlmAgent(
    name="reimbursements", model="gemini-3-flash-preview",
