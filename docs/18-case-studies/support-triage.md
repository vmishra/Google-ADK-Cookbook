...
```mermaid
flowchart TB
  U[User] --> C[Coordinator<br/>gemini-2.5-flash]
...
tech = LlmAgent(name="tech", model="gemini-2.5-flash",
...
returns = LlmAgent(name="returns", model="gemini-2.5-flash",
    description="Return and RMA requests.",
    instruction="...", tools=[...])

root_agent = LlmAgent(
    name="front_desk", model="gemini-2.5-flash",
