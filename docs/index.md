...
| Gemini default | `gemini-3-flash-preview` | The cost–latency balance most chapters want. |
| Gemini reasoning | `gemini-3.1-pro-preview` | Deep research, planning, hard tool-use. |
